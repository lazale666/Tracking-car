	                    ...
	                    //       -2   -1    +1    +2    -2   -1   +1    +2
{
	...
	if(/*GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_14)==1 || */GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_11)==1)
		turn_dat+=2;
	if(/*GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_15)==1 || */GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_12)==1)
		turn_dat+=1;
	if(/*GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_9 )==1 || */GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_6 )==1)
		turn_dat-=1;
	if(/*GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_10)==1 || */GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_7 )==1)
		turn_dat-=2;
...
{
	if(GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_11)==0 && GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_12)==0 && GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_6)==0 && GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_7)==0)
		return 1;
	else
		return 0;
}
